#!/usr/bin/env bash
# ==============================================================================
# Cluster A — 3B end-to-end pipeline for `mad_scc` (mad_vote baseline +
# scc_components SCC modules). Mirrors run_mad_scc_1.5b.sh but targets the
# qwen25-3b-instruct model. Outputs land under results_mad_scc/.
#
...
#                             paper_tables/mad_scc_A1_3b.{csv,md}
#                             paper_tables/mad_scc_A2_3b.{csv,md}
#
...
#   bash exp/run_mad_scc_3b.sh
#   bash exp/run_mad_scc_3b.sh --max_samples 5         # smoke test
#   ANALYZE_ONLY=1 ANALYZE_DIR=results_mad_scc/run_<TS> \
#     bash exp/run_mad_scc_3b.sh                       # rebuild tables
#   DATASETS="GSM8K AQUA-RAT" bash exp/run_mad_scc_3b.sh
#   VARIANTS_FILTER="A0_vanilla A4_all" bash exp/run_mad_scc_3b.sh
#   POOL_DIR=results_archive/results_diagnostic/run_other \
#     bash exp/run_mad_scc_3b.sh                       # different pool
# ==============================================================================
set -euo pipefail
...
echo "=================================================="
echo "  Cluster A — 3B end-to-end pipeline (mad_scc)"
echo "  Time         : $(date)"
...
echo ""
echo "=================================================="
echo ">> Cluster A 3B pipeline (mad_scc) finished: $(date)"
echo ">> Run dir : ${RUN_ROOT}"
