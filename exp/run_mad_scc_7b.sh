#!/usr/bin/env bash
# ==============================================================================
# Cluster A — 7B end-to-end pipeline for `mad_scc` (mad_vote baseline +
# scc_components SCC modules). Mirrors run_mad_scc_1.5b.sh but targets the
# qwen25-7b-instruct model. Outputs land under results_mad_scc/.
#
...
#                             paper_tables/mad_scc_A1_7b.{csv,md}
#                             paper_tables/mad_scc_A2_7b.{csv,md}
#
...
#   bash exp/run_mad_scc_7b.sh
#   bash exp/run_mad_scc_7b.sh --max_samples 5         # smoke test
#   ANALYZE_ONLY=1 ANALYZE_DIR=results_mad_scc/run_<TS> \
#     bash exp/run_mad_scc_7b.sh                       # rebuild tables
#   DATASETS="GSM8K AQUA-RAT" bash exp/run_mad_scc_7b.sh
#   VARIANTS_FILTER="A0_vanilla A4_all" bash exp/run_mad_scc_7b.sh
#   POOL_DIR=results_archive/results_diagnostic/run_other \
#     bash exp/run_mad_scc_7b.sh                       # different pool
# ==============================================================================
set -euo pipefail
...
echo "=================================================="
echo "  Cluster A — 7B end-to-end pipeline (mad_scc)"
echo "  Time         : $(date)"
...
echo ""
echo "=================================================="
echo ">> Cluster A 7B pipeline (mad_scc) finished: $(date)"
echo ">> Run dir : ${RUN_ROOT}"
