...
#   mad_scc_A1_3b_run{1,2,3}.csv / .md        (per-run paper tables)
#   mad_scc_A1_3b_mean.csv                    (cross-run mean only)
#   mad_scc_A1_3b_meanstd.csv                 (mean ± std)
#   mad_scc_A2_3b_run{1,2,3}.csv / .md
#   mad_scc_A2_3b_mean.csv / _meanstd.csv
#   soo_scc_A1_3b_run{1,2,3}.csv / .md
#   soo_scc_A1_3b_mean.csv / _meanstd.csv
#   soo_scc_A2_3b_run{1,2,3}.csv / .md
#   soo_scc_A2_3b_mean.csv / _meanstd.csv
#
...
#   bash exp/run_both_scc_3b_3runs.sh
#   bash exp/run_both_scc_3b_3runs.sh --max_samples 5  # smoke test
#   N_RUNS=5 bash exp/run_both_scc_3b_3runs.sh         # change run count
#   STOP_ON_FAIL=1 bash exp/run_both_scc_3b_3runs.sh   # abort on any failure
#
...
mkdir -p logs
LOG_FILE="logs/run_both_scc_3b_3runs_${TIMESTAMP}.log"
...
for ((i=1; i<=N_RUNS; i++)); do
    ...
    run_step "mad_scc 3B (run ${i})" "${SCRIPT_DIR}/run_mad_scc_3b.sh" || true
    run_step "soo_scc 3B (run ${i})" "${SCRIPT_DIR}/run_soo_scc_3b.sh" || true
