#!/usr/bin/env bash
# ==============================================================================
# Cluster A — 3B end-to-end pipeline for `soo_scc` (selforg / DAG-cascade
# baseline + scc_components SCC modules). Mirrors run_soo_scc_1.5b.sh but
# targets the qwen25-3b-instruct model. Outputs land under results_soo_scc/.
#
...
#                             paper_tables/soo_scc_A1_3b.{csv,md}
#                             paper_tables/soo_scc_A2_3b.{csv,md}
#
# Round 0 is replayed from the SHARED initial pool at
#   results_archive/results_diagnostic/run_20260501_130540/qwen25-3b-instruct
...
# pool exists yet for 3B. Override POOL_DIR if/when one becomes available.
#
...
#   bash exp/run_soo_scc_3b.sh
#   bash exp/run_soo_scc_3b.sh --max_samples 5         # smoke test
#   ANALYZE_ONLY=1 ANALYZE_DIR=results_soo_scc/run_<TS> \
#     bash exp/run_soo_scc_3b.sh                       # rebuild tables
#   DATASETS="GSM8K AQUA-RAT" bash exp/run_soo_scc_3b.sh
#   VARIANTS_FILTER="A0_vanilla A4_all" bash exp/run_soo_scc_3b.sh
# ==============================================================================
set -euo pipefail
...
POOL_DIR="${POOL_DIR:-results_archive/results_diagnostic/run_20260501_130540/qwen25-3b-instruct}"
...
echo "=================================================="
echo "  Cluster A — 3B end-to-end pipeline (soo_scc)"
echo "  Time         : $(date)"
...
echo ""
echo "=================================================="
echo ">> Cluster A 3B pipeline (soo_scc) finished: $(date)"
echo ">> Run dir : ${RUN_ROOT}"
