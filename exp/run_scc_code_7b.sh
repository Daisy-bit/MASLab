#!/usr/bin/env bash
# ==============================================================================
# Cluster A — 7B code pipeline. Runs **both** soo_scc and mad_scc end-to-end
# with the 5-cell code ablation matrix on HumanEval + MBPP-500. Mirrors
# run_scc_code_1.5b.sh but targets the qwen25-7b-instruct model.
#
...
# Per-method paper tables: paper_tables/<method>_code_7b.{csv,md}.
#
...
#   bash exp/run_scc_code_7b.sh                        # full both-methods run
#   bash exp/run_scc_code_7b.sh --max_samples 5        # smoke test
#   DATASETS=HumanEval bash exp/run_scc_code_7b.sh     # single dataset
#   METHODS=soo_scc bash exp/run_scc_code_7b.sh        # one method only
#   VARIANTS_FILTER="A0_vanilla A4_all" bash exp/run_scc_code_7b.sh
#   EVAL_ONLY=1 ANALYZE_DIR_SOO_SCC=results_soo_scc_code/run_<TS> \
#     ANALYZE_DIR_MAD_SCC=results_mad_scc_code/run_<TS> \
#     bash exp/run_scc_code_7b.sh                      # rebuild tables only
# ==============================================================================
set -euo pipefail
...
echo "=================================================="
echo "  Cluster A — 7B code pipeline (both methods)"
echo "  Time         : $(date)"
...
echo ""
echo "=================================================="
echo ">> Cluster A 7B code pipeline (both methods) finished: $(date)"
for METHOD in $METHODS; do
