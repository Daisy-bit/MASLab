#!/usr/bin/env bash
# ==============================================================================
# Cluster A — 1.5B end-to-end pipeline for `soo_scc` (selforg / DAG-cascade
# baseline + scc_components SCC modules). Mirrors run_mad_scc_1.5b.sh but
# targets the v3-faithful refactor (methods/soo_scc/) and writes outputs
# under results_soo_scc/.
#
...
#                             paper_tables/soo_scc_A1_1.5b.{csv,md}
#                             paper_tables/soo_scc_A2_1.5b.{csv,md}
#
...
#   bash exp/run_soo_scc_1.5b.sh
#   bash exp/run_soo_scc_1.5b.sh --max_samples 5         # smoke test
#   ANALYZE_ONLY=1 ANALYZE_DIR=results_soo_scc/run_<TS> \
#     bash exp/run_soo_scc_1.5b.sh                       # rebuild tables
#   DATASETS="GSM8K AQUA-RAT" bash exp/run_soo_scc_1.5b.sh
#   VARIANTS_FILTER="A0_vanilla A4_all" bash exp/run_soo_scc_1.5b.sh
# ==============================================================================
set -euo pipefail
...
echo "=================================================="
echo "  Cluster A — 1.5B end-to-end pipeline (soo_scc)"
echo "  Time         : $(date)"
...
echo ""
echo "=================================================="
echo ">> Cluster A 1.5B pipeline (soo_scc) finished: $(date)"
echo ">> Run dir : ${RUN_ROOT}"
